...
\newcommand{\Leafset}{V_{\mathrm{leaf}}}
...
By \lemref{max2degpath_props}(iii),
a MinRS containing a leaf of the DFS-tree
contains exactly one leaf of the DFS-tree.
Thus,
...
\begin{lem}
  ...
  forms the $a$--$x$ \maxTwoDegPath,
  where $a \in V \setminus \{r,x\}$ is an ancestor of $x$ in $T$.
